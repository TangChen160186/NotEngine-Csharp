...
{
    public static void Serialize(string filePath,Mesh mesh)
    {
        using BinaryWriter writer = new BinaryWriter(File.Open(filePath, FileMode.Create));
        // 写入顶点数量
        writer.Write(mesh.AssetId.ToByteArray());
    ...
    public static void DeSerialize(string filePath,out Mesh mesh)
    {
        ...
        mesh = new Mesh(vertices, indices, guid);
    }
}